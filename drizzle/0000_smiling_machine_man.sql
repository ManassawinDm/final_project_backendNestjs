...
ALTER TABLE "transfer_requests" ADD CONSTRAINT "transfer_requests_period_id_transfer_periods_id_fk" FOREIGN KEY ("period_id") REFERENCES "public"."transfer_periods"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
